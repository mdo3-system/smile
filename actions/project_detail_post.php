...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ファイルアップロード関連（成果物・通常アップロード・他ファイル記載・CAD公開トグル・一括UP）
    elseif (in_array($action, ['upload_artifact', 'toggle_cad_publish']) || in_array(($_POST['action_type'] ?? ''), ['single_upload', 'bulk_upload']) || (isset($_FILES['upload_file']) && $_FILES['upload_file']['error'] === UPLOAD_ERR_OK)) {
