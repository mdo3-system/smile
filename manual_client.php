    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="timeline">
                ...
                <div class="timeline-item">
                    <div class="timeline-title">ステップ5: 一次回答へのチェックバック (CB) ＆ 着手金ご清算</div>
                    <div class="timeline-desc">提示された一次回答に意匠上の変更や要望がある場合は、右側の「チャット」でチェックバック資料をUPします。また、一次請求書（50%分）が発行されますのでお振込みをお願いします。</div>
                </div>
                <div class="timeline-item">
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-desc">確認申請の審査が合格（完了）しましたら、最終請求書（残り50%）を発行します。ご入金確認をもって、正式な署名捺印済みの安全証明書や最終計算書データ一式を受け取ることができます。</div>
                </div>
            </div>
