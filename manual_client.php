            ...
            <div class="grid-desc">
                ...
                <div class="desc-col">
                    ...
                    <ul>
                        ...
                        <li><strong>通知のON/OFF切り替え</strong>: 各案件の詳細画面の左上「基本情報」エリアに配置されている<b>「🔔 メール通知設定」</b>リンクをクリックすることで、ご自身のメール通知受信（ON/OFF）をいつでも個別に切り替えることができます。（※ご自身のログインアカウントのみに適用され、他のメンバーの設定を変更することはできません）</li>
