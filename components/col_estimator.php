    ...
    <div class="box" style="background:#e8f5e9; font-size:11px; display:flex; flex-direction:column; gap:10px; border: 2px solid #28a745;">
        ...
        <div style="margin-top:10px; display:flex; gap:10px; flex-direction:column;">
            <div style="display:flex; gap:10px;">
                ...
                <button type="button" id="pdf_issue_btn" onclick="saveAndPrintEstimate(false)" style="flex:2; background:#ff9800; border:none; color:white; padding:5px; font-size:11px; cursor:pointer; font-weight:bold; border-radius:3px;">印刷用PDFを発行</button>
                <button type="button" id="formal_pdf_issue_btn" onclick="saveAndPrintEstimate(true)" style="flex:2; background:#dc3545; border:none; color:white; padding:5px; font-size:11px; cursor:pointer; font-weight:bold; border-radius:3px;">本見積として確定・PDF発行</button>
            </div>
        </div>
    </div>
</div>
